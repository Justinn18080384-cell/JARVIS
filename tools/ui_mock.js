...
(function () {
  ...
  const api = {
    ...
    dashboard: async () => ({ system: { cpu: 23, ram: 51, ram_used: 16.4e9, ram_total: 32e9, cpu_name: "AMD Ryzen 7 5800X", cores: 16, host: "GAMING-PC",
      ...
      habits: { screen_today: 13800, games_today: 5400, games_week: 31200, recording: false,
        top_today: [{ app: "FiveM", sec: 5400, game: true }, { app: "Discord", sec: 3600, game: false }, { app: "Microsoft Edge", sec: 2400, game: false }, { app: "Spotify", sec: 1500, game: false }],
        top_games_week: [{ app: "FiveM", sec: 22000 }, { app: "GTA V", sec: 6200 }, { app: "Rocket League", sec: 3000 }] },
