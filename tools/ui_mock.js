...
(function () {
  ...
  const api = {
    ...
    phone: async () => ({ adb: false, devices: [], remote: { enabled: true, running: true, port: 8765, url: "https://jarvis-pc.tailxxxx.ts.net:8765", tailscale: true,
      qr: "", clients: 1, push_devices: 1, push_mode: "away", speak_on_pc: false } }),
    finance: async () => ({ month_name: "September", month_spent: 642.37, month_earned: 1850, prev_spent: 710.2, today_spent: 12.5, forecast: 837.9, count: 48,
      by_category: [{ category: "Essen & Trinken", sum: 231.4, n: 19 }, { category: "Auto & Tanken", sum: 160, n: 3 }, { category: "Gaming", sum: 89.99, n: 2 },
        { category: "Abos & Streaming", sum: 41.97, n: 3 }, { category: "Shopping", sum: 119.01, n: 4 }],
      months: [{ month: "Apr", spent: 580, earned: 1850 }, { month: "Mai", spent: 790, earned: 1850 }, { month: "Jun", spent: 655, earned: 1850 },
        { month: "Jul", spent: 920, earned: 1900 }, { month: "Aug", spent: 710.2, earned: 1850 }, { month: "Sep", spent: 642.37, earned: 1850 }],
      budgets: [{ category: "Essen & Trinken", monthly: 250, used: 231.4, pct: 93 }, { category: "Gaming", monthly: 60, used: 89.99, pct: 150 }, { category: "Gesamt", monthly: 1000, used: 642.37, pct: 64 }],
      subs: [{ id: 1, name: "Netflix", amount: 13.99, interval: "monat", next_due: "2026-10-03", monthly: 13.99 }, { id: 2, name: "Spotify", amount: 10.99, interval: "monat", next_due: "2026-10-15", monthly: 10.99 },
        { id: 3, name: "Xbox Game Pass", amount: 16.99, interval: "monat", next_due: "2026-09-28", monthly: 16.99 }],
      subs_monthly: 41.97,
      recent: [{ id: 5, day: "2026-09-23", amount: -12.5, category: "Essen & Trinken", note: "Rewe" }, { id: 4, day: "2026-09-22", amount: -60, category: "Auto & Tanken", note: "ARAL Tankstelle" },
        { id: 3, day: "2026-09-20", amount: -89.99, category: "Gaming", note: "Steam" }, { id: 2, day: "2026-09-15", amount: 1850, category: "Einnahmen", note: "Gehalt September" }],
      categories: ["Essen & Trinken", "Auto & Tanken", "Wohnen", "Abos & Streaming", "Gaming", "Shopping", "Handy & Internet", "Versicherung", "Freizeit", "Gesundheit", "Unterwegs", "Einnahmen", "Sonstiges"] }),
